...
public class JFXSpinnerAnimation extends Transition {
     ...
     */
    public JFXSpinnerAnimation(final JFXSpinner node, double startValue, double endValue, Duration duration) {
        this.node = node;
        ...
        x.addListener((ob, n, n1) -> {
            node.setProgress(n1.doubleValue());
        });
