...
public class MoveXAnimation extends Transition{
     ...
     */
    public MoveXAnimation(final Node node, double startValue, double endValue, Duration duration) {
        this.node = node;
        ...
        x.addListener((ob, n, n1) -> {
            node.setLayoutX(n1.doubleValue());
        });
